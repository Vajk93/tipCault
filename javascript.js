...
alert("if you are on desktop, use enter key, if not, the custom function does't work, so you can use buttons to see results");
//**************************************************************
// summary:
...
customInputField.value = "";
buttonPressed();
billInputField.style.border = "none";
personsInputField.style.border = "none";
customInputField.style.border = "none";
};
